...
// NewTenantIdentityManager - returns a new instance of the tenant-identity manager
func NewTenantIdentityManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
